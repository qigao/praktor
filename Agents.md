...
- **`cpp-design-patterns`** - C++ 设计模式实现指南（GoF 23 种模式、RAII/CRTP/Type Erasure/Pimpl/Policy-Based Design、SOLID 原则、反模式警告）
- **`cpp-tmp`** - C++ 模板与元编程实战指南（函数/类/变量模板、特化、SFINAE、Concepts、变参模板、折叠表达式、constexpr/consteval、类型特征、TMP、表达式模板）
