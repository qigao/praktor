...
TEST_CASE("mpmc::PriorityQueue - Write to empty, lowest priority and read back", "[mpmc_pq_write_empty_lowest]") {
...
TEST_CASE("mpmc::PriorityQueue - Write to empty, highest priority and read back", "[mpmc_pq_write_empty_highest]") {
    lockfree::mpmc::PriorityQueue<int16_t, 20, 3> queue;
