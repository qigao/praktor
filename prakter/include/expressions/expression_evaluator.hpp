#ifndef PRAKTER_EXPRESSIONS_EXPRESSION_EVALUATOR_HPP
#define PRAKTER_EXPRESSIONS_EXPRESSION_EVALUATOR_HPP
...
#endif  // PRAKTER_EXPRESSIONS_EXPRESSION_EVALUATOR_HPP
