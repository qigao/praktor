...
if(CMAKE_CROSSCOMPILING)
    if(NOT PRAKTOR_HOST_LEMON_EXECUTABLE OR
       NOT EXISTS "${PRAKTOR_HOST_LEMON_EXECUTABLE}")
        message(FATAL_ERROR "Cross builds require PRAKTOR_HOST_LEMON_EXECUTABLE built for the host")
    endif()
    set(LEMON_EXECUTABLE "${PRAKTOR_HOST_LEMON_EXECUTABLE}")
    set(LEMON_DEPENDS "${PRAKTOR_HOST_LEMON_EXECUTABLE}")
elseif(TARGET lemon)
