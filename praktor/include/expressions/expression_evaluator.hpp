#ifndef PRAKTOR_EXPRESSIONS_EXPRESSION_EVALUATOR_HPP
#define PRAKTOR_EXPRESSIONS_EXPRESSION_EVALUATOR_HPP
...
public:
  Value evaluate(const std::string &expression, const WorkflowContext &context) const;

  Value evaluate(const std::string &expression, const WorkflowContext &context,
                 const FunctionRegistry &registry) const;

  bool evaluateAsBool(const std::string &expression, const WorkflowContext &context) const;

  bool evaluateAsBool(const std::string &expression, const WorkflowContext &context,
                      const FunctionRegistry &registry) const;
...
#endif // PRAKTOR_EXPRESSIONS_EXPRESSION_EVALUATOR_HPP
